        ...
        {sent ? card(
          ...
          <>
            ...
            <div style={{ padding:'24px 28px', display:'flex', flexDirection:'column', gap:12 }}>
              ...
              {/* Вход через Google убран 2026-09-08 — 406-ФЗ запрещает
                  авторизацию граждан РФ через иностранные сервисы
                  (Google/Apple и т.п.) с 01.12.2023. Перед удалением
                  проверено: у аккаунта kulyak963@gmail.com (единственный,
                  кто входил через Google) теперь есть пароль — задан
                  напрямую и подтверждён живым входом, чтобы никто не
                  остался без доступа. Замена на российский OAuth
                  (Яндекс ID/VK ID) — отдельная задача, см. MIGRATION.md. */}
